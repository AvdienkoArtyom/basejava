...
public class TestDataResume {
    ...
    public static Resume createResumeUUID(String uuid, String name) {
        ...
        experienceList.add(new Organization("Experience 1 " + uuid, Arrays.asList(new Period(DateUtil.of(2013, Month.OCTOBER), LocalDate.now(), "Status experience 1 " + uuid, "Description experience 1 " + uuid)), "сайт"));
        experienceList.add(new Organization("Experience 2 " + uuid, Arrays.asList(new Period(DateUtil.of(2014, Month.OCTOBER), DateUtil.of(2016, Month.JANUARY), "Status experience 2 " + uuid, "Description experience 2 " + uuid)), "сайт"));
        resume.getSection().put(SectionType.EXPERIENCE, new OrganizationSection(experienceList));

        List<Organization> educationList = new ArrayList<>();
        educationList.add(new Organization("Education 1 " + uuid, Arrays.asList(new Period(DateUtil.of(1997, Month.SEPTEMBER), DateUtil.of(1998, Month.MARCH), "Description education 1 " + uuid)), "сайт"));
        educationList.add(new Organization("Education 2 " + uuid, Arrays.asList(new Period(DateUtil.of(1987, Month.SEPTEMBER), DateUtil.of(1993, Month.JULY), "Description education 2 " + uuid), new Period(DateUtil.of(1993, Month.SEPTEMBER), DateUtil.of(1996, Month.JULY), "Description education 2 " + uuid)), "сайт"));
